package com.lz.rxrequestlib.download;
...
import static com.lz.rxrequestlib.download.DownParamBean.STATU_CANCEL;
import static com.lz.rxrequestlib.download.DownParamBean.STATU_FINISH;
import static com.lz.rxrequestlib.download.DownParamBean.STATU_PAUSE;
import static com.lz.rxrequestlib.download.DownParamBean.STATU_PROGRESS;
        ...
        if (!mParamBean.isCancle()) {
            ...
            if (!mParamBean.isDownloading) {
                if (null != mConsumer) {
                    ...
                    resetStutus();
                    mParamBean.status = DownParamBean.STATU_CANCEL;
                    callBackListener();
                }
            }
        }
